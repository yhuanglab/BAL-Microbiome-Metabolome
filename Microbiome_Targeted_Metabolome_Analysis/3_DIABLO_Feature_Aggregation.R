...
coef_pred_df <- read.csv(paste("/home/madapoos/Spiromics_No_Severe_No_Healthy_UNC_Reg/Output/", response_variable, "/DIABLO_Model_Features_ORs_P_Values_Raw.csv", sep = ""))
...
write.csv(coef_pred_df_sig_aggregated, paste("/home/madapoos/Spiromics_No_Severe_No_Healthy_UNC_Reg/Output/", response_variable, "/DIABLO_Model_Features_ORs_P_Values.csv", sep = ""), row.names = F)
