...
df <- read.csv('~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_UNC_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/DIABLO_Model_Accuracies_Groups.csv')
...
#plot
pdf("~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_UNC_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/DIABLO_Classification_Accuracy_by_Clinical_Parameter_Groups.pdf", 
	width = 10, 
	height = 10)
ggplot(data = df) + 
