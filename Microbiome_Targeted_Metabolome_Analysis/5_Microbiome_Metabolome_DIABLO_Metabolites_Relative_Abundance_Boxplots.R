...
bac <- read.csv('~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_UNC_Stratified/Spiromics_No_Severe_No_Healthy/Data/Esther_Metabolites_No_Severe_No_Healthy.csv') #Metabolite relative abundance data
...
write.csv(df_raw, file = paste("~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_UNC_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/", target_variable, "/Metabolite_Significance_Tests_by_Levels_of_", target_variable, ".csv", sep = ""))
...
myplot <- function(i) { #plots individual boxplots using ggplot
	...
	#Generate boxplot
	pdf(paste("~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_UNC_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/", target_variable, "/Metabolite_Boxplots/", i, "_Intensity_by", target_variable, ".pdf", sep=""))
	p <- ggplot(data = dz) +
...
pdf(paste("~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_UNC_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/", target_variable, "/Metabolite_Boxplots/All_Metabolites_Intensity_.pdf", sep=""), width = 20, height = 20)
