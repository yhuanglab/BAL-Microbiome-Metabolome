...
pdf(paste("~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/", target_variable, "/DIABLO_Model_Metabolite_Feature_Importance_Stripchart.pdf", sep = ""))
plot(plot)
dev.off()
