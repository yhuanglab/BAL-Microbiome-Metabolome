...
#response_variable <- "CB_SGRQ02.y"

num_iterations <- 100 #number of bootstrapped training and testing sets to run model on

#read in data sets
env <- read.csv("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Data/Clinical_Parameters_04_21_20_No_Severe_No_Healthy.csv", header=T)
met <- read.csv("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Data/BALF_C18_Norm_Log2_Transposed_No_Severe_No_Healthy.csv", header = T, stringsAsFactors = FALSE)
bac <- read.csv("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Data/BALF_Decontam_Only_OTU_Relative_Abundances_Genus_04_06_19_No_Severe_No_Healthy.csv", header = T, stringsAsFactors = FALSE)
...
while (j <= num_iterations) { #model generation over all resampling iterations
	...
	met_raw <- read.csv("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Data/BALF_C18_Norm_Log2_Transposed_No_Severe_No_Healthy.csv", header = T)
	...
	otu_raw <- read.csv("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Data/BALF_Decontam_Only_OTU_Relative_Abundances_Genus_04_06_19_No_Severe_No_Healthy.csv", header = T, stringsAsFactors = FALSE)
	...
	if (j == 1) { #if it's the first model it's automatically the best model
		...
		saveRDS(best_model, file = paste("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Output/", response_variable, "/", response_variable, "_Best_Model.rds", sep = "")) #save model as R object to read in later
...
model_parameters_names <- c("Number of DIABLO-Identified Optimal Metabolites", 
...
mean_model_parameters <- c(mean_num_diablo_optimal_met,
...
best_model_parameters <- c(best_diablo_num_optimal_met,
...
write.csv(model_parameters, file = paste("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Output/", response_variable, "/DIABLO_Model_Parameters.csv", sep = ""), row.names = F)
...
#write.csv(optimal_met_list, file = paste("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Output/", target_variable, "/DIABLO_Model_Metabolite_Features.csv", sep = ""), row.names = F)
...
#write.csv(optimal_bac_list, paste("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Output/", target_variable, "/DIABLO_Model_OTU_Features.csv", sep = ""), row.names = F)
...
write.csv(coef_pred_df, file = paste("/home/madapoos/Spiromics_No_Severe_No_Healthy_Reg/Output/", response_variable, "/DIABLO_Model_Features_ORs_P_Values_Raw.csv", sep = ""), row.names = F)
