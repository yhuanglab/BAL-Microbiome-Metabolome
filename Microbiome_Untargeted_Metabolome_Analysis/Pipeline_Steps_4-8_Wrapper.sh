...
Rscript ~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Code/4_DIABLO_Model_Accuracy_Graph.R
...
#clear existing output file if present
rm ~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Output/Heatmap/DIABLO_Num_Models_Heatmap/Top_Features_by_Num_Sig_Models_No_Unknowns.csv

#create new output file
touch ~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Output/Heatmap/DIABLO_Num_Models_Heatmap/Top_Features_by_Num_Sig_Models_No_Unknowns.csv
...
do
	...
	#echo "Starting $i"
	cd $i #Enter folder
	Rscript ~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Code/6_DIABLO_Top_Features_Extraction.R
	#echo "***********"
	cd .. #Exit folder
done
...
Rscript ~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Code/7_DIABLO_Feature_Direction_of_Effects.R

echo "7_DIABLO_Feature_Direction_of_Effects.R --- DONE"
echo "************************************************"
echo "7_DIABLO_Feature_Num_Models_Heatmap.R--- RUNNING"

Rscript ~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Code/7_DIABLO_Feature_Num_Models_Heatmap.R
...
Rscript ~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Code/8_DIABLO_Feature_Pearson_Network.R

echo "8_DIABLO_Feature_Pearson_Network.R --- DONE"
echo "************************************************"
echo "8_DIABLO_Feature_Pearson_Correlation_Heatmap.R --- RUNNING"

Rscript ~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Code/8_DIABLO_Feature_Pearson_Correlation_Heatmap.R
