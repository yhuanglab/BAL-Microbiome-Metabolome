...
number_of_otus_to_plot <- 3 #based on inflection point from stripchart if there is one; otherwise plot top 10 OTUs
...
bac <- read.csv('~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Data/BALF_Decontam_Only_OTU_Relative_Abundances_Genus_04_06_19_No_Severe_No_Healthy.csv') #OTU relative abundance data
...
write.csv(df_raw, file = paste("~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/", target_variable, "/OTU_Significance_Tests_by_Levels_of_", target_variable, ".csv", sep = ""))
...
myplot <- function(i) { #plots individual boxplots using ggplot
	...
	#Generate boxplot
	pdf(paste("~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/", target_variable, "/OTU_Boxplots/", i, "_Relative_Abundance_by", target_variable, ".pdf", sep=""))
	p <- ggplot(data = dz) +
...
pdf(paste("~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/", target_variable, "/OTU_Boxplots/All_OTUs_Relative_Abundance_.pdf", sep=""), width = 20, height = 20)
