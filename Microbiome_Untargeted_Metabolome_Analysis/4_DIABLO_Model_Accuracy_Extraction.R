...
if (target_variable == "BRON_PEX_HCUDRUG_365_A.y_1_Oneormore_0_None") {
	...
	write.table(df, file = "~/Desktop/Spiromics_BAL_Microbiome_Metabolome_V2/Spiromics_Colorado_Stratified/Spiromics_No_Severe_No_Healthy/Output/DIABLO/DIABLO_Model_Accuracies_Groups.csv", 
					sep = ",", 
					append = TRUE, 
					row.names = FALSE, 
					col.names = FALSE)
